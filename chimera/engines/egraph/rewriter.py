...
from chimera.core.smt_parser import parse_file, parse_string as parse_str
from chimera.core.smt_ast import Const, Script, Term, Var as AstVar, DeclareFun
from chimera.core.types import *
from chimera.engines.egraph.type_sys import *
...
if __name__ == "__main__":
    ...
    if transformed_irs:
        ...
        if "any_int" in new_term_str:
            ...
            term_candidate = str(random.randint(1, 100))
