...
class SolverTheoryProfile:
    """Theory profile for a solver configuration."""
...
DEFAULT_PROFILE = SolverTheoryProfile(
    # Theories broadly used across solvers in this repo
    general=(
        "fp",
        "int",
        "real",
    ...
    # Bitwuzla is intentionally small.
    bitwuzla_only=(
        "core",
        "fp",
        "bv",
...
def _norm_solver(name: str | None) -> str:
    """Normalize solver name to lowercase."""
