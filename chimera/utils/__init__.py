"""
Utility functions for Chimera fuzzer.

This module provides file handling and SMT string utilities.
...
def format_smt_string(smt_string: str) -> str:
    """Clean up an SMT-LIB string by removing redundant whitespace and empty lines."""
