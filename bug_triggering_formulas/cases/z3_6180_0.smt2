...
(assert (= c f))
(assert (= f (bvor f c)))
(assert (bvule (bvsub (bvadd (_ bv4270377 32) ((_ zero_extend 30) _a) ((_ zero_extend 30) _a) ((_ zero_extend 16) f) ((_ zero_extend 28) b) ((_ zero_extend 16) d) i ((_ zero_extend 16) e)) (_ bv4270344 32)) (_ bv423 32)))
(assert (distinct (_ bv1 2) _a))
(assert (bvule (bvadd i (_ bv4270377 32) ((_ zero_extend 16) d) ((_ zero_extend 16) f) ((_ zero_extend 30) _a) ((_ zero_extend 30) _a)) (_ bv4271190 32)))
